...
## Frontier highlights
- [[evallab-results-2026-04-30-kazmmlu-kk-qwen-qwen3-0-6b-base|evallab/results/2026-04-30__KazMMLU-kk__Qwen-Qwen3-0.6B-Base.json]] — Canonical protocol pinned in code: 9,870-Q kk split, 3-shot (dev=3 hard max), letter-logit, Qwen3-0.6B=0.328
...
## Sources & findings (1)
- [[evallab-results-2026-04-30-kazmmlu-kk-qwen-qwen3-0-6b-base|evallab/results/2026-04-30__KazMMLU-kk__Qwen-Qwen3-0.6B-Base.json]] — [tested-on-Kazakh] The lab's canonical protocol is fully pinned in code and a committed result record: KazMMLU Kazakh-la…
