---
type: "moc"
topic: "mla-upcycling-at-1b-under-a-bespoke-toke"
nodes: 5
papers: 5
sources: 0
uncertain_claims: 3
...
## Papers (5)
- [[care-covariance-aware-and-rank-enhanced-decomposition-for-enabling-multi-head|CARE: Covariance-Aware and Rank-Enhanced Decomposition for Enabling Multi-Head Latent Attention]] (2026) — mla-upcycling-at-1b-under-a-bespoke-toke
...
- [[universal-cross-tokenizer-distillation-via-approximate-likelihood-matching|Universal Cross-Tokenizer Distillation via Approximate Likelihood Matching]] (2025) — mla-upcycling-at-1b-under-a-bespoke-toke
- [[zebra-llama-towards-extremely-efficient-hybrid-models|Zebra-Llama: Towards Extremely Efficient Hybrid Models]] (2025) — mla-upcycling-at-1b-under-a-bespoke-toke
