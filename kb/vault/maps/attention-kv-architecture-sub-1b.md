---
type: "moc"
topic: "attention-kv-architecture-sub-1b"
nodes: 12
papers: 10
sources: 2
uncertain_claims: 8
...
- [[mellum2-technical-report|Mellum2 Technical Report]] (2026) — attention-kv-architecture-sub-1b
- [[gemma-3-technical-report|Gemma 3 Technical Report]] (2025) — sota-slm
- [[gated-attention-for-large-language-models-non-linearity-sparsity-and-attention|Gated Attention for Large Language Models: Non-linearity, Sparsity, and Attention-Sink-Free]] (2025) — attention-kv-architecture-sub-1b
...
- [[base-of-rope-bounds-context-length|Base of RoPE Bounds Context Length]] (2024) — attention-kv-architecture-sub-1b
- [[gated-delta-networks-improving-mamba2-with-delta-rule|Gated Delta Networks: Improving Mamba2 with Delta Rule]] (2024) — attention-kv-architecture-sub-1b
