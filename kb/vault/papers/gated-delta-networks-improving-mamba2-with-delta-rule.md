...
- [[empirical-this-session-smoke2-py-on-local-rtx-2070-sm75|Empirical, this session: smoke2.py on local RTX 2070 (SM75)]] — GatedDeltaNet from this paper PASSES on SM75 but at 14K tok/s/layer (28-47x SDPA) via fla-0.5.1 fallback configs
